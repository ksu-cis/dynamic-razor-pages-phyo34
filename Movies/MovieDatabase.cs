...
namespace Movies
{
    ...
    public static class MovieDatabase
    {
        ...
        // The genre represented in the database
        ...
        /// <returns>A collection of moives</returns>
        ...
        public static IEnumerable<Movie> FilterByMPAARating(IEnumerable<Movie> movies, IEnumerable<string> ratings)
        {
            ...
            foreach (Movie movie in movies)
            {
                if (MPAARatings != null && ratings.Contains(movie.MPAARating))
                {
                    results.Add(movie);
                }
            }
        ...
        /// <summary>
        /// Filters the provided collection of movies to those with IMDB ratings falling within the specified range
        /// </summary>
        /// <param name="movies">The collection of movies to filter</param>
